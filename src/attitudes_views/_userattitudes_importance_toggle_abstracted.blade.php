...
<?php $uid = uniqid(); ?>
<div class="set_intensity un_flex un_flex_ht" data-remote-radio-change="true" data-method="post" data-url="{{ route('abstracted.set_user_importance', ['itemkind' => $itemkind,'id' => $o->id]) }}" data-spinner="true"  title="IK: {{$itemkind}} #{{$o->id}}">
