...
<?php $uid = uniqid(); ?>
    <div class="set_attitude un_flex un_flex_ht" data-remote-radio-change="true" data-method="post" data-url="{{ route('attitudes.set_user_attitude', ['itemkind' => $itemkind, 'id' => $o->id]) }}" data-spinner="true" title="IK: {{$itemkind}} #{{$o->id}}">
